...
export const mobileSections: MobileSection[] = [
  ...
  },
  {
    label: 'Sua Jornada',
    items: [
      { label: '📊 Jornada', href: '/jornada', page: 'jornada', userOnly: true },
      { label: '🎯 Missões', href: '/missoes', page: 'missoes', userOnly: true },
      { label: '🎓 Trilhas', href: '/trilhas', page: 'trilhas', userOnly: true },
      { label: '🏆 Conquistas', href: '/conquistas', page: 'conquistas', userOnly: true },
    ],
  },
  {
    label: 'Personalizado',
    items: [
      { label: '🫘 Grãos', href: '/graos', page: 'graos', userOnly: true },
      { label: '☕ Torrefação', href: '/torrefacao', page: 'torrefacao', userOnly: true },
      { label: '📚 Biblioteca', href: '/biblioteca', page: 'biblioteca', userOnly: true },
      { label: '👤 Perfil', href: '/perfil', page: 'perfil', userOnly: true },
    ],
  },
]
