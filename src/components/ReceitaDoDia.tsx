...
export default function ReceitaDoDia() {
  ...
  if (!recipe) {
    return (
      <a href="/receitas/" class="glass-card p-6 group block relative overflow-hidden">
        ...
        <div class="flex items-start gap-4">
          ...
          <div class="flex-1 min-w-0">
            ...
            <div class="flex items-center gap-3 text-xs text-[var(--color-text-muted)]">
              <span>Do coado perfeito às sobremesas de acompanhamento</span>
              <span class="flex items-center gap-1 group-hover:gap-2 transition-all ml-auto text-[var(--color-accent)]">
                Ver receitas
